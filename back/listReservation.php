    ...
    <div class="row">
        <div class="col align-self-center">
            <table class="table table-striped" id="tableListResa">
                <thead>
                    <tr>
                        <th scope="col" class="numResaBack">N°</th>
                        <th scope="col" class="lastnameBack">Nom</th>
                        <th scope="col" class="firstnameBack" id="fistnameResaBack">Prénom</th>
                        <th scope="col" class="numTelBack">Téléphone</th>
                        <th scope="col" class="mailBack" id="mailResaBack">Adresse mail</th>
                        <th scope="col" class="dateResaBack" id="dateResaBack">Date</th>
                        <th scope="col" class="hourResaBack" id="hourResaBack">Heure</th>
                        <th scope="col" class="nbPersBack" id="nbPersResaBack">Nombre</th>
                        <th scope="col" class="numTableBack" id="numTableResaBack">Table</th>
                ...
                <tbody>
                    <?php foreach ($arrayResa as $resa) { ?>
                        <tr>
                            <th scope="row"> <?= $resa->reservation_id ?> </th>
                            ...
                            <th scope="row" id="mailResaBackForeach"> <?= $resa->reservation_mail ?> </th>
