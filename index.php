<?php
    session_start();
    if(isset($_POST['submitEmptyCart'])){
        unset($_SESSION['cart']);
        session_destroy();
    }
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="" id="formCart">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" name="submitEmptyCart" id="submitEmptyCart">Vider le panier</button>
            ...
            <div class="row" id="pageWebOrdinateur">
                ...
                <div class="col-12 col-md-6" id="formWidth">
                    <?php if ($addResaSuccess){
                        ?>
                        <p class="pFormWidth">Réservation n°<?= $reservation->reservation_id ?> enregistrer au nom de <?= $reservation->reservation_lastname ?> <?= $reservation->reservation_firstname ?> le <?= date('d m Y', strtotime($reservation->reservation_dateResa)) ?> à <?= $reservation->reservation_hourResa ?>.</p>
                            <p>
